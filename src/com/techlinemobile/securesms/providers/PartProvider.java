...
import com.techlinemobile.securesms.mms.PartUriParser;
import com.techlinemobile.securesms.service.KeyCachingService;
import com.techlinemobile.securesms.util.MemoryFileUtil;
...
public class PartProvider extends ContentProvider {
  ...
  private static final String CONTENT_URI_STRING = "content://com.techlinemobile.provider.securesms/part";
  ...
  static {
    ...
    uriMatcher.addURI("com.techlinemobile.provider.securesms", "part/*/#", SINGLE_ROW);
  }
