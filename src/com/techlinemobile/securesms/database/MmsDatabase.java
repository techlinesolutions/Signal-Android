 ...
 */
package com.techlinemobile.securesms.database;
...
import com.techlinemobile.securesms.attachments.MmsNotificationAttachment;
import com.techlinemobile.securesms.database.documents.IdentityKeyMismatch;
import com.techlinemobile.securesms.database.documents.IdentityKeyMismatchList;
import com.techlinemobile.securesms.database.documents.NetworkFailure;
import com.techlinemobile.securesms.database.documents.NetworkFailureList;
import com.techlinemobile.securesms.database.helpers.SQLCipherOpenHelper;
...
import com.techlinemobile.securesms.database.model.NotificationMmsMessageRecord;
import com.techlinemobile.securesms.database.model.Quote;
import com.techlinemobile.securesms.jobs.TrimThreadJob;
...
import com.techlinemobile.securesms.util.JsonUtils;
...
//  }
  ...
  public void markIncomingNotificationReceived(long threadId) {
    ...
    if (com.techlinemobile.securesms.util.Util.isDefaultSmsProvider(context)) {
      DatabaseFactory.getThreadDatabase(context).incrementUnread(threadId, 1);
    }
  ...
  public class Reader {
    ...
    private NotificationMmsMessageRecord getNotificationMmsMessageRecord(Cursor cursor) {
      ...
      if (!TextUtils.isEmpty(contentLocation))
        contentLocationBytes = com.techlinemobile.securesms.util.Util.toIsoBytes(contentLocation);

      if (!TextUtils.isEmpty(transactionId))
        transactionIdBytes = com.techlinemobile.securesms.util.Util.toIsoBytes(transactionId);
