...
import com.techlinemobile.securesms.components.emoji.EmojiToggle;
import com.techlinemobile.securesms.contacts.avatars.ResourceContactPhoto;
import com.techlinemobile.securesms.crypto.ProfileKeyUtil;
...
import com.techlinemobile.securesms.profiles.ProfileMediaConstraints;
import com.techlinemobile.securesms.profiles.SystemProfileUtil;
...
import com.techlinemobile.securesms.util.FileProviderUtil;
import com.techlinemobile.securesms.util.IntentUtils;
...
public class CreateProfileActivity extends BaseActionBarActivity implements InjectableType {
  ...
  private Intent createAvatarSelectionIntent(@Nullable File captureFile, boolean includeClear, boolean includeCamera) {
    ...
    if (includeClear) {
      extraIntents.add(new Intent("com.techlinemobile.securesms.action.CLEAR_PROFILE_PHOTO"));
    }
