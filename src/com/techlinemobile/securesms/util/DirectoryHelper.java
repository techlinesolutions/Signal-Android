...
import com.techlinemobile.securesms.contacts.ContactsDatabase;
...
import com.techlinemobile.securesms.sms.IncomingJoinedMessage;
...
public class DirectoryHelper {
  ...
  private static Optional<AccountHolder> getOrCreateAccount(Context context) {
    ...
    Account[]      accounts       = accountManager.getAccountsByType("com.techlinemobile.securesms");
  ...
  private static Optional<AccountHolder> createAccount(Context context) {
    AccountManager accountManager = AccountManager.get(context);
    Account        account        = new Account(context.getString(R.string.app_name), "com.techlinemobile.securesms");
